...
public abstract class TripListFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<TripInfo, TripViewHolder> mAdapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<TripInfo, TripViewHolder>(TripInfo.class, R.layout.trip_item,
